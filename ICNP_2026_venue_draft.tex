...
\begin{tikzpicture}[
    ...
    >=Latex,
    basebox/.style={rectangle, draw, rounded corners=4pt, align=center, minimum height=0.95cm, text width=5.00cm, inner sep=4pt, font=\bfseries},
    ...
    mainbox/.style={rectangle, draw=black!70, fill=black!4, rounded corners=6pt, align=center, minimum height=1.1cm, text width=5.0cm, inner sep=5pt, font=\bfseries},
    arrow/.style={thick,->}
]
