...
\noindent\textit{RQ2b. Which model family degrades most gracefully and consistently defines the efficiency frontier across all threat scenarios?}

\noindent\textit{RQ3a. Does predictive (ARIMA-informed) context improve routing stability?}

\noindent\textit{RQ3b. Do larger replay-capacity scales ($T_b \rightarrow T$) improve routing robustness?}

\noindent\textit{RQ3c. Is there a universal allocator strategy for entanglement routing under threat variation?}

\noindent\textit{RQ3d. Can we map threat characteristics to stable deployment rules for entanglement routing?}
