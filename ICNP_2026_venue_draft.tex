...
% -----------------------------------------------------------------------------
% Figure audit staging: figures only, no surrounding unrevised manuscript text.
% -----------------------------------------------------------------------------
...
% TODO: Add remaining figure environments from main.tex as they are reached in the audit.
% Keep this draft figure-only for unaudited material; do not copy tables or full sections until accepted.
...
% Placeholder. This subsection will be audited after the MAB subsection decision.
