...
\begin{tikzpicture}[
  ...
  out/.style={rectangle, draw=black, rounded corners=3pt, align=center, minimum height=0.58cm, text width=1.86cm, inner sep=2pt, fill=black!8},
...
\node[out, below=0.55cm of grid, xshift=-2.00cm] (metrics) {Metrics};
\node[out, below=0.55cm of grid] (robust) {Robustness};
\node[out, below=0.55cm of grid, xshift=2.00cm] (guidance) {Guidance};
