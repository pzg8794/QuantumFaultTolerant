...
\caption{Replay capacity has threat-dependent effects. The generated figure shows where additional replay scale improves efficiency and where it reduces robustness under adaptive disruption.}
