...
\end{tikzpicture}
\caption{Four-path quantum-network testbed used for routing evaluation. Paths $P_1$ and $P_2$ have two hops, while $P_3$ and $P_4$ have three hops; per-path qubit budgets are varied by allocator policy.\shee{I think the colors in main.tex was easier to distinguish the paths. }}
