...
\end{tikzpicture}
\caption{The topology provides two shorter two-hop paths ($P_1$, $P_2$) and two
longer three-hop paths ($P_3$, $P_4$), creating the path-length and
qubit-allocation tradeoff evaluated throughout the study.}
