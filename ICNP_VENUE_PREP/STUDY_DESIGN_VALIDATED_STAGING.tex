...
\end{tikzpicture}
\caption{Four-path quantum-network testbed used for routing evaluation. Color and line style distinguish paths: $P_1$ is solid, $P_2$ dashed, $P_3$ dotted, and $P_4$ dash-dotted. Paths $P_1$ and $P_2$ have two hops, while $P_3$ and $P_4$ have three hops; per-path qubit budgets are varied by allocator policy.}
