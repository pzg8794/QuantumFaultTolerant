...
\midrule
Efficiency & \texttt{Oracle}-normalized routing performance, reported as a percentage. \\
\texttt{Oracle} gap & Difference between achieved efficiency and the \texttt{Oracle} reference. \\
Robustness floor & Lowest efficiency observed across the evaluated threat settings. \\
CV & Coefficient of variation across scenario-level means; lower values indicate more stable performance. \\
$s$ & Replay-capacity scale factor; larger $s$ increases the replay scale. \\
...
Run suite & Repeated execution group used to average stochastic experimental outcomes. \\
