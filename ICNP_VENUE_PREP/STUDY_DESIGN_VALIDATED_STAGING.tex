...
\cref{sec:SystemModel} defines the configuration axes used to answer \cref{sec:research_questions}. \Cref{tab:notation_metrics} defines all declared variables and \Cref{tab:config_summary} summarizes the design dimensions, tested options, and RQ coverage.
