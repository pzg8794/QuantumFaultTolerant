...
This subsection expands the concise main-body summary in \Cref{tab:testbed_comparison_summary} with the full per-testbed comparison table, while the following subsection expands the family-level summary in \Cref{tab:model_family_comparison_summary}.
