...
reliable: \texttt{EXPNeuralUCB} falls to an 18\% robustness floor, while the
...
50-node \paperSeven{} setting, where it reaches 78\% versus 70.8\% for the
next strongest models, and it still remains best on the larger \paperTwelve{}
fusion topology, where methods compress tightly at 44\% versus 43.8\%.
