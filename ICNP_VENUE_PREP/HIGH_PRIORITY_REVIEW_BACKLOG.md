...
| H4 | H | Review and fix figure-internal labels/titles created by earlier figure-generation workflows. | **Open** | Latest LaTeX formatting was normalized, but PNG/TikZ image-internal labels were generated earlier and remain our responsibility. This is separate from subfigure caption formatting. | Audit all main-body and appendix figure images for notebook-style wording, inconsistent casing, tiny labels, unsupported labels, and non-venue phrasing. Regenerate or replace figures where needed. |
