...
\begin{abstract}
This standalone plot pack collects the seven ICNP candidate result figures generated from the validated result artifacts. It is a review artifact only and is not automatically included by \texttt{main.tex}.
\end{abstract}
