...
This divide leaves three deployment-critical comparative gaps insufficiently isolated in prior evaluations:
\begin{enumerate}
...
To address these gaps, we have developed a \emph{robust routing evaluation framework}
