...
\begin{enumerate}
\item \textbf{Adversarial-first approaches} (\eg EXP3-family designs~\cite{auer2002nonstochastic,huang2024quantum}) assume worst-case link behavior and prioritize robustness under attack, often sacrificing stochastic efficiency.
