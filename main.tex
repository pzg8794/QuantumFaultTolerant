...
However, existing quantum routing research often evaluates algorithms under \emph{incompatible assumptions, metrics, or threat models}, complicating direct comparisons and obscuring deployment tradeoffs~\cite{wang2025learning,huang2024quantum,liu2024qbgp,li2025multipath}. This heterogeneity makes it difficult to attribute performance differences to the learning rule itself rather than to differences in topology scale, physics/noise modeling, allocation assumptions, or adversary behavior. Consequently, results can be hard to translate into actionable deployment guidance when conditions drift or disruptions adapt. Two streams are especially prominent:
