...
\begin{scope}[on background layer]
    \node[draw, rounded corners=6pt, fit=(topology)(threats)(models), inner sep=8pt,
          label=above:{\textbf{Experimental Inputs}}] {};
    \node[draw, rounded corners=6pt, fit=(allocator)(capacity)(engine), inner sep=10pt,
          label=above:{\textbf{Evaluation Process}}] {};
    \node[draw, rounded corners=6pt, fit=(metrics)(comparison)(guidance), inner sep=8pt,
          label=above:{\textbf{Outputs}}] {};
\end{scope}
