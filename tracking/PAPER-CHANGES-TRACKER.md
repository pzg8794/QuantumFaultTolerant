...
| C-047 | 2026-02-20 | Introduction | Dan: “what gap? Add a few words context.” | Add 1–3 words clarifying what “gap” refers to so the sentence reads standalone | Planned |  | T-2026-007, T-2025-011 | Target the “To address these gaps …” sentence in `Our Approach and Evaluation Scope` |
...
- **Proposed fix:** Add 1–3 words clarifying that the gap is comparative (matched-threat / apples-to-apples comparison).
- **Note (2026-02-26):** A prior micro-edit attempted to clarify the “This divide leaves … gaps …” sentence, but it was reverted to avoid changing text that was not directly flagged. Apply the clarifier instead at the “To address these gaps …” sentence in `\subsection{Our Approach and Evaluation Scope}`.
