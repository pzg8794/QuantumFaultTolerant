...
| C-026 | 2026-02-16 | Cleanup | Resolved comment markers remain | Remove resolved comment markers | Done | 5990ad2 | T-2026-007, T-2025-011 | Removed in-draft reviewer macros (`\\dan{...}`, `\\devroop{...}`) and stray TODO/link dumps from `main.tex` |
