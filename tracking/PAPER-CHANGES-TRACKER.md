...
| C-046 | 2026-02-20 | Introduction | Dan: “Find newer citations if you can.” | Add 1–2 newer citations in the intro where they materially strengthen motivation (no padding) | Done | TBD | T-2026-007, T-2025-015 | Applied: added `pompili2021realization` to the opening “quantum Internet applications” sentence; refined adversarial-stream parenthetical to “EXP3-family and adversarial-adaptive” and included `zimmert2019optimal` (already in `refs.bib`). Note: kept repeater-based architectures anchored by `briegel1998quantum` only (did not attribute `pompili2021realization` specifically to repeater architecture). |
...
- **Applied (2026-02-20):**
  - Added `pompili2021realization` (Science 2021 multi-node network demo) to strengthen the “quantum Internet applications” motivation (newer anchor).
  - Kept repeater-based architectures anchored by `briegel1998quantum` (foundational repeater architecture reference); did not attribute `pompili2021realization` specifically to repeaters.
