...
| C-044 | 2026-02-20 | Introduction | Dan: “These should have citations… build this up… drive home the problem.” (re: incompatible assumptions/threat models) | Add citations supporting the incompatibility claim; add 1–2 sentences that connect incompatibility to attribution difficulty + weak deployment generalization | Done | TBD | T-2026-007, T-2025-015 | Applied in `main.tex`: added `~\\cite{wang2025learning,huang2024quantum,liu2024qbgp,li2025multipath}` + two motivation sentences before the “Two streams…” list |
...
- **Applied (2026-02-25):** Added `~\cite{wang2025learning,huang2024quantum,liu2024qbgp,li2025multipath}` to that sentence and inserted two follow-on sentences explaining why heterogeneity confounds attribution and weakens deployment generalization.
